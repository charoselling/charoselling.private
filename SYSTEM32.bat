...
::============================================================================
::
::   This script is a part of '%titlename% Selling Activator' project.
::
...
echo:
echo:
echo Help - discord.gg/TcNJGSwfRe
echo:
echo:
ping 127.0.0.1 -n 10
)
...
%nceline%
echo Script is launched from the temp folder,_
...
:Extract$OEM$
pause Error Press Any Key To Exit
exit
cls
...
if %_erl%==1 start https://discord.gg/TcNJGSwfRe &goto at_menu
goto :at_menu
